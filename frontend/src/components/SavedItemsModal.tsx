...
export default function SavedItemsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-0 sm:p-4 overflow-y-auto animate-in fade-in duration-150">
      <div className="bg-white rounded-none sm:rounded-2xl shadow-2xl border-0 sm:border border-gray-100 w-full max-w-2xl h-full sm:h-auto max-h-[100dvh] sm:max-h-[85vh] flex flex-col overflow-hidden relative sm:my-auto">
        {/* Header */}
